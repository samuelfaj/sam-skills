#!/usr/bin/env python3
"""Validate Fable advisor model, effort, and safety routing."""
...
def main() -> int:
    ...
    if default_plan["model"] != "fable" or default_plan["effort"] != "high":
    ...
    print("PASS: Fable advisor model, effort override, stdin, and read-only contract")
    return 0
