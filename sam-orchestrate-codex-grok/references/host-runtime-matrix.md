...
- Any STANDARD re-prompt after capability failure (still Grok high until Sol-high)
- Never lower effort for urgency, cost, or latency

### Use `xhigh`

- All `DEEP` Grok producers
- Any DEEP re-prompt after capability failure (still Grok xhigh until Sol-high)
